...
export interface CreatePurchaseOrderDialogRef {
...
export const CreatePurchaseOrderDialog = React.forwardRef<CreatePurchaseOrderDialogRef, CreatePurchaseOrderDialogProps>(
...
CreatePurchaseOrderDialog.displayName = 'CreatePurchaseOrderDialog';
